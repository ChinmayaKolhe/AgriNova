    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="crop-recommendations" element={<CropRecommendations darkMode={darkMode} />} />
          <Route path="ai-assistant" element={<AIAssistant darkMode={darkMode} />} />
          <Route path="planting-calendar" element={<PlantingCalendar darkMode={darkMode} />} />
          ...
          {/* Marketplace Routes */}
          <Route path="marketplace/sell" element={<SellProduce darkMode={darkMode} />} />
          <Route path="marketplace/buy" element={<BuyProducts darkMode={darkMode} />} />
        </Route>
      </Routes>
    </BrowserRouter>
  );
